...
set "GITHUB_VERSION_URL=https://raw.githubusercontent.com/KOUISHOURAXIO/zapret/main/.service/version.txt"
set "GITHUB_RELEASE_URL=https://github.com/KOUISHOURAXIO/zapret/releases/"
set "GITHUB_DOWNLOAD_URL=https://github.com/KOUISHOURAXIO/zapret/releases/latest/download/zapret"
