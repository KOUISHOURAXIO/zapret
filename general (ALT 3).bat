...
--filter-tcp=443 --ipset="%LIST%list-cloudflare&amazon.txt" --dpi-desync=split --dpi-desync-split-pos=1 --dpi-desync-autottl --dpi-desync-fooling=badseq --dpi-desync-repeats=8
