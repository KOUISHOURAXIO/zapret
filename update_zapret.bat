...
set "GITHUB_URL=https://raw.githubusercontent.com/KOUISHOURAXIO/zapret/refs/heads/main/.service/version.txt"
set "RELEASE_URL=https://github.com/KOUISHOURAXIO/zapret/releases"
