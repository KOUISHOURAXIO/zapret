...
> :warning: **НЕ ЗАПУСКАЙТЕ ZAPRET.EXE, ОН САМ ПО СЕБЕ НИЧЕГО НЕ ДЕЛАЕТ (ЭТО ДЛЯ СОЗДАНИЯ СЛУЖБЫ `ZAPRET`), ИСПОЛЬЗУЙТЕ .BAT!!!**

Скачайте последний [релиз](https://github.com/KOUISHOURAXIO/zapret-bypass/releases), разархивируйте в отдельную папку
